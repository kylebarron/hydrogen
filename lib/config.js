...
const Config = {
  ...
  schema: {
    ...
    stripIndentBeforeSendToKernel: {
      title: "Strip common leading whitespace before sending to kernel",
      includeTitle: false,
      description:
        'For the given language grammars, Hydrogen will remove common leading whitespace before sending to the kernel. For example ``` ["source.python"] ```.',
      type: "string",
